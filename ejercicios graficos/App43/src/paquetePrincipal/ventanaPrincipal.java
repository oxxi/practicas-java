...
java.sql.Statement sentencia;
    ...
    private void btnVerDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerDatosActionPerformed
        ...
        try {
            ...
            r.beforeFirst();
            while ( r.next()) {                
                info=info+r.getString("nombre")+" "+r.getString("apellido")+
                    "Su sueldo es : "+r.getString("sueldo")+"\n";
                sueldott=sueldott + r.getDouble("sueldo");
            }
            JOptionPane.showMessageDialog(null, info);
            JOptionPane.showMessageDialog(null, "La suma de los sueldos es: "+sueldott);
        } catch (Exception e) {
