...
public class ventanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nemuCascada = new javax.swing.JMenuItem();
        ...
        menuArchivoAbriir.add(menuArchivoInfo);
        ...
        menuArchivoAbriir.add(menuCerrarTodo);
        ...
        nemuCascada.setText("Cascada");
        nemuCascada.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nemuCascadaActionPerformed(evt);
            }
        });
        menuVentana.add(nemuCascada);

        menuArchivo.add(menuVentana);
    ...
    private void menuArchivoInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuArchivoInfoActionPerformed
        ...
        if (vActiva!=null) {
            ...
            JOptionPane.showMessageDialog(null,"La ruta de la Imagen es: "+titulo);
        }else{
    ...
    private void nemuCascadaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nemuCascadaActionPerformed
        // TODO add your handling code here:
        int x,y;
        JInternalFrame v[] = panelInterno.getAllFrames();
        x=0;
    ...
    }//GEN-LAST:event_nemuCascadaActionPerformed
    ...
    private javax.swing.JMenuItem nemuCascada;
